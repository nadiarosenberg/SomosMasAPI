...
exports.findAll = (req, res) => {
  ...
  Category.findAll({attributes: ["title", "class", "images", "createdAt", "id"], order: [["createdAt", "DESC"]]})
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
exports.findOne = (req, res) => {
  ...
  Category.findByPk(id, {attributes: ["title", "content", "class" , "images", "createdAt", "id"]})
    .then(data => {
      if ( data === null ) {
        res.status(404).send({
